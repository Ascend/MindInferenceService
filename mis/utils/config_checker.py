...
class ConfigChecker:
    ...
    def is_int_value_in_range(name: str, value: int, min_value: int = None, max_value: int = None, 
        ...
        if valid_values is None:
            return ConfigChecker._validate_value(name, value, int, min_value, max_value)
        else:
            return ConfigChecker._validate_value(name, value, int, valid_values=valid_values)

    @staticmethod
    def is_float_value_in_range(name: str, value: float, min_value: float = None, max_value: float = None, 
                                valid_values: List[float] = None):
        if valid_values is None:
            return ConfigChecker._validate_value(name, value, (int, float), min_value, max_value)
        else:
            return ConfigChecker._validate_value(name, value, (int, float), valid_values=valid_values)
    ...
    @staticmethod
    def _validate_value_range(name: str, value, value_type, min_value=None, max_value=None):
